...
# files
COVID_DATA_JSON = 'dags/files/{0}_{1}'.format(today, config.get('FILE', 'COVID_DATA_JSON'))
COVID_DATA_CSV = 'dags/files/{0}_{1}'.format(today, config.get('FILE', 'COVID_DATA_CSV'))
TEMP_DATA_DIR = config.get('FILE', 'TEMP')

# s3
COVID_DATA_BUCKET = config.get('S3', 'BUCKET')
S3_KEY = '{0}_{1}'.format(today, config.get('FILE', 'COVID_DATA_CSV'))
